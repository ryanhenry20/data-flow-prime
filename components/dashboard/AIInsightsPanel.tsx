...
const insights = [
    {
        ...
        description:
            'User engagement increased 24% in the mobile segment. Consider mobile-first campaigns.',
        impact: 'High',
        confidence: 89,
        icon: TrendingUp,
        color: 'green',
    },
    {
        ...
        description:
            'Desktop conversion rates dropped 8% this week. Investigate checkout flow issues.',
        impact: 'Medium',
        confidence: 76,
        icon: AlertTriangle,
        color: 'orange',
    },
    {
        ...
        description:
            'Users from social media spend 3x more time on product pages but have lower conversion.',
        impact: 'Medium',
        confidence: 92,
        icon: Lightbulb,
        color: 'purple',
                            ...
                            <div className="flex items-start gap-3">
                                <div
                                    className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                                        colorClasses[
                                            insight.color as keyof typeof colorClasses
                                        ]
                                    }`}>
